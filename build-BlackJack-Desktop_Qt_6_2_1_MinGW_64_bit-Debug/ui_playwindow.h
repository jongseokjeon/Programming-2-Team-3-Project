...
public:
    ...
    void setupUi(QMainWindow *PlayWindow)
    {
        ...
        computerLabel->setGeometry(QRect(620, 10, 161, 41));
        QPalette palette3;
        ...
        youLabel->setGeometry(QRect(20, 0, 61, 41));
        QPalette palette4;
        ...
        layoutWidget->setGeometry(QRect(0, 430, 401, 25));
        ...
        stickButton_2 = new QPushButton(layoutWidget);
        stickButton_2->setObjectName(QString::fromUtf8("stickButton_2"));

        horizontalLayout_12->addWidget(stickButton_2);

        label = new QLabel(centralwidget);
        label->setObjectName(QString::fromUtf8("label"));
        label->setGeometry(QRect(80, 50, 56, 12));
    ...
    void retranslateUi(QMainWindow *PlayWindow)
    {
        ...
        label->setText(QCoreApplication::translate("PlayWindow", "current:0", nullptr));
