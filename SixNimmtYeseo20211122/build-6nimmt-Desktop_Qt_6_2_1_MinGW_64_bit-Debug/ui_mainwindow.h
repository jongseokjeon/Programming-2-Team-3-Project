...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        closeButton->setGeometry(QRect(340, 300, 141, 23));
        playButton = new QPushButton(centralWidget);
        playButton->setObjectName(QString::fromUtf8("playButton"));
        playButton->setGeometry(QRect(130, 260, 211, 71));
        playButton->setStyleSheet(QString::fromUtf8("background-image: url(:/images/images/startbutton.png);"));
        pictureLabel = new QLabel(centralWidget);
        pictureLabel->setObjectName(QString::fromUtf8("pictureLabel"));
        pictureLabel->setGeometry(QRect(0, 0, 461, 351));
